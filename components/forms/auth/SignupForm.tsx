    ...
    return (
        <main className="min-h-screen bg-white flex flex-col items-center justify-start md:justify-center md:py-12">
            <div className="w-full md:max-w-[600px] bg-white overflow-hidden md:rounded-[24px] md:shadow-[0_8px_40px_rgba(0,0,0,0.10)]">
                ...
                {/* ── Header Image — organza floral (Floreal Collection). Masked to fade to
                     transparent at the bottom so it dissolves into the card's white background
                     instead of getting hard-cropped. Shared with Login / Reset. ── */}
                <div
                ...
                >
                    <div className="px-7 lg:px-12 pb-14 lg:pb-16">
                                ...
                                {(field) => {
                                    ...
                                    return (
                                        <>
                                            ...
                                            {showError
                                                ? <FieldError errors={field.state.meta.errors} isTouched={field.state.meta.isTouched} />
                                                : <p className="text-[#8B8282] text-[13px] mt-1.5">Use at least 12 characters.</p>}
                                        </>
                                    );
                                }}
                            </form.Field>
                        ...
                        <p className="text-center text-[16px] font-medium text-[#1a1a1a]">
                            ...
                            <a href="/auth/login" className="text-[#4E8ED9] underline">
                                Log in
                            </a>
                        </p>
                    </div>
